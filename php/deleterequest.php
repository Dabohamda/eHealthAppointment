<?php 
	...
	?>
	    <p>
	    <strong>Jeu</strong> : <?php echo $donnees['nom_patient']; ?><br />
	    Le possesseur de ce jeu est : <?php echo $donnees['prenom_patient']; ?>, et il le vend à <?php echo $donnees['date_naissance']; ?> euros !<br />
